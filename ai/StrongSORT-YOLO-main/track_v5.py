...
def run(
        ...
        count=True,  # get counts of every obhects
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                # /memory/huqiang/Polyp/images/none_polyp/images/AQ
                # /home/daiwenxuan/code/StrongSORT-YOLO-main/data/AQ.txt
                #with open('/home/daiwenxuan/code/Polyp/polyp_segmentation/StrongSORT-YOLO-main/data/'+opt.source.split('/')[-1]+'.txt', 'a') as file:
                #        file.write(str(dataset.count))
                #        file.write("\n")
            ...
            if save_vid:
                ...
                if vid_path[i] != save_path:  # new video
                    ...
                    # 确保在释放旧的VideoWriter之后，再创建新的VideoWriter
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/memory/huqiang/Polyp/images/none_polyp/images/AQ', help='file/dir/URL/glob, 0 for webcam')  
